...
def load_data_fashion_mnist(batch_size, resize=None):
    ...
    mnist_train = gluon.data.vision.FashionMNIST(root="../data/fashion-mnist", train=True)
    mnist_test = gluon.data.vision.FashionMNIST(root="../data/fashion-mnist", train=False)
